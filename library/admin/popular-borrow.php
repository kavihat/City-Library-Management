...
$query -> execute();
$_SESSION['delmsg']="Document deleted scuccessfully ";
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Most Borrowed Documents </h4>
    </div>
     <div class="row">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
<?php $sql = $sql = "SELECT borrows.*,documents.*, COUNT(BorrowId) AS post_count from borrows LEFT JOIN documents on borrows.DocId = documents.DocId GROUP BY borrows.DocId ORDER BY post_count DESC LIMIT 10";
// "SELECT  * from documents ORDER BY PubDate DESC  limit 10";
