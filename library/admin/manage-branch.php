...
{
$id=$_GET['del'];
$sql = "delete from branchtbl  WHERE LibId=:id";
$query = $dbh->prepare($sql);
$query -> bindParam(':id',$id, PDO::PARAM_STR);
$query -> execute();
$_SESSION['delmsg']="Branch deleted";
...
<head>
    ...
    <title>Online Library Management System | Manage Branch</title>
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Manage Branch</h4>
    </div>
     <div class="row">
