                        ...
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                           ...
                           <!--
                            ...
                            <li>
                                ...
                                <a href="manage-branch.php" class="menu-top-active"> Branches </a>
                                <!--
								<ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                    
                                     <li role="presentation"><a role="menuitem" tabindex="-1" href="manage-branch.php">Manage Branches</a></li>
                                </ul>
								-->
								
                            </li>
                            <li>
                                <a href="#" class="dropdown-toggle" id="ddlmenuItem" data-toggle="dropdown"> Documents <i class="fa fa-angle-down"></i></a>
                                <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="add-book.php">Add Book</a></li>
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="add-journal.php">Add Journal</a></li>
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="add-proceedings.php">Add Proceedings</a></li>

                                </ul>
                            </li>
							
                           <li>
						        <a href="signup.php" class="menu-top-active"> Add Reader </a>
                               <!-- <a href="#" class="dropdown-toggle" id="ddlmenuItem" data-toggle="dropdown"> ADD READER <i class="fa fa-angle-down"></i></a>
                                <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="signup.php">ADD READER</a></li> 
									</ul>  -->
                           ...
                           <li>
						        <a href="manage-issued-books.php" class="menu-top-active"> Issued Books </a>
						   <!--
